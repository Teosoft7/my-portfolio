...
const stacks = [
  ...
  },
  {
    ...
    items: ["SQL", "MongoDB", "Pandas", "PySpark"],
    description: "Designing large-scale ETL pipelines and robust databases for media spending and behavioral analytics."
  },
  {
    category: "Backend & API",
    icon: <Code2 className="w-6 h-6 text-purple-400" />,
    items: ["Python", "FastAPI", "Docker", "AWS"],
    description: "Architecting scalable FastAPI backends to transform ML/AI models into reliable production services."
  },
  {
    category: "Frontend & Visualization",
    icon: <Code2 className="w-6 h-6 text-orange-400" />,
    items: ["Next.js", "React", "TypeScript", "Tailwind", "Plotly"],
    description: "Building interactive web/mobile interfaces and analytical dashboards that bring data insights to life."
  }
];
